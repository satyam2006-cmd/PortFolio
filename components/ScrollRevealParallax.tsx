...
const ProfileTextOverlay = ({
  ...
  const opacity = useTransform(progress, (v: number) => (v >= 0 ? 1 : 0));
  const x = useTransform(progress, (v: number) => (v >= 0 ? 0 : -10));
  ...
  return (
    <motion.div
      style={{
        ...
        x,
        textAlign: "left",
        maxWidth: isSmall ? "85%" : isMobile ? "60%" : "450px",
        display: "flex",
    ...
    >
      ...
      >
        <div>
          ...
          <p
            style={{ fontSize: isSmall ? "0.85rem" : "1rem", fontWeight: 500 }}
          >
            India
          </p>
        </div>
        ...
        <div>
          <p
            style={{
              ...
              letterSpacing: "0.4em",
              opacity: 0.4,
              marginBottom: isSmall ? "0.5rem" : "1.2rem",
              fontWeight: 800,
            }}
          >
            CONNECT
          ...
          >
            <a
              href="http://github.com/satyam2006-cmd/"
              target="_blank"
...
const EducationOverlay = ({
  ...
  // Show on all devices, but adjust styles for mobile
  return (
    <motion.div
      style={{
        position: "absolute",
        ...
        pointerEvents: "auto",
        textShadow: "0 2px 10px rgba(0,0,0,0.8)", // Ensure readability
      }}
    >
      <div style={{ marginBottom: isMobile ? "1rem" : "2.5rem" }}>
        <p
        ...
        <div style={{ marginBottom: isMobile ? "1rem" : "2.5rem" }}>
          ...
          <h2
            style={{
              fontSize: isMobile ? "0.9rem" : "2.2rem",
              fontFamily: "serif",
              margin: "0 0 0.3rem 0",
              fontWeight: 400,
              lineHeight: 1.1,
...
const ScrollRevealParallax: React.FC<Props> = ({ children }) => {
  ...
  const inset = isSmall ? "8px" : isMobile ? "12px" : "30.5px";
  ...
  const clipPath = "circle(150% at 50% 100%)";
